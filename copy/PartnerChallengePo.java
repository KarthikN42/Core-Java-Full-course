...
public class PartnerChallengePo extends WebBasePage implements Constants {

	public PartnerChallengePo(WebDriver driver) {
		super(driver);
	}
	...
	@FindBy(xpath = "//*[@id='Common_CW_wt50_block_wt19_wtNavigation_wtNavigationMenu_Common_CW_wt57_block_RichWidgets_wt662_block_wtMenuItem_wt58']")
	private WebElement selectVideoClick;

	@FindBy(xpath = "//*[@id='Common_CW_wt95_block_wt19_wtContent_wtMainContent_Spotcheck_Pat_wt78_block_wtTableeRecords_wtVimeoVideoTable_ctl03_wt117']/span")
	private WebElement copyvideo;
	...
	@FindBy(xpath = "//*[@id='Common_CW_wt50_block_wt19_wtContent_wtMainContent_OutSystemsUIWeb_wt310_block_wtContent_wtChallenge_GoalPeriodId']")
	private WebElement dailyGoal;
	...
	@FindBy(xpath = "//*[@id='Common_CW_wt50_block_wt19_wtContent_wtMainContent_OutSystemsUIWeb_wt231_block_wtContent']//input")
	private WebElement B2CChekBox;

	@FindBy(xpath = "//div[@class='margin-top-s']//input[@title='Search']")
	private WebElement B2B;

	@FindBy(xpath = "//label[contains(text(),'Corporate')]")
...
//	}
	...
	public void B2COrB2B(String channel) throws InterruptedException {

	    
		if (channel.equals("B2C")) {
			verifyElement(B2CChekBox, "B2C ChekBox");
			B2CChekBox.click();
		} else {
			...
			B2B.click();
			Thread.sleep(5000);
			verifyElement(B2B, "B2B");
			B2B.sendKeys("nokia" + Keys.ENTER);
			B2B.sendKeys("Silicon valley" + Keys.ENTER);
			outerclick.click();
		}
...
//	}
	...
	public void createchallenge() throws InterruptedException, AWTException {
		...
		goTochallenge();
		createNew();
		name();                      name.sendKeys("automation hiking challenge B2B");
		startDateClick();
		todayDateClick();
		endDateClick();              endDate.sendKeys("10-07-2022");
		description();               description.sendKeys("hiking Challenge automation ");
		imageUpload();
